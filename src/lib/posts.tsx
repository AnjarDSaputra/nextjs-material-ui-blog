...
export const getPost = async (id: string, includeContent = false): Promise<PostData> => {
  console.log("getpost")
  console.log(id)
  ...
  var raw = JSON.stringify({
      "operation": "sql",
      "sql": "SELECT * FROM Totok431Pasien.Blog where id = "+id
  });
  ...
  console.log(avatars)
  return getPostFromFile(avatars, id, includeContent)
}
